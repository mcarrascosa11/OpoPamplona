...
> técnico, citando el artículo concreto en 'exp' y añadiendo 'subtema' como
> texto libre breve que identifique el contenido concreto evaluado. No crees
> una taxonomía cerrada de tipos de pregunta. No toques ninguna otra pregunta.
> Después, añade un resumen del tema E35 a src/data/resumenes.js con el mismo
> formato que el resumen G1 (intro, bloques, claves).
...
Además, ejecuta antes de incorporar el lote:

`node scripts/calidad-preguntas.mjs E35`

El script comprueba estructura, IDs duplicados, preguntas casi duplicadas y
los delatores estadísticos ya medidos en el banco. Los avisos estadísticos no
son un motivo automático para reescribir una pregunta aislada: sirven para
detectar patrones en conjuntos suficientemente grandes.
